...
class HolidayChecker:
    ...
    缓存文件遵循 AstrBot 插件开发规范，存储于:
        data/plugin_data/astrbot_plugin_everyday_weatherforecast/holiday_cache.json
    """
    ...
    def __init__(self, data_dir: str, enabled: bool = True):
        ...
        self.cache_file = os.path.join(data_dir, "holiday_cache.json")
